...
eval "$(fzf --zsh)"
eval "$('/usr/local/bin/node' -r '/Users/nlorio/conductor/workspaces/notion-next/miami/esbuild-runner.js' '/Users/nlorio/conductor/workspaces/notion-next/miami/src/cli/main/notion.ts' completion --install)"
