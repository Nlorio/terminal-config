// Bloom / glow shader for Ghostty.
// Extracts bright pixels, samples them along a golden-spiral kernel, and adds
// the blurred result back so bright text (and the cursor) bleeds a soft halo.
//
// Source: https://gist.github.com/qwerasd205/c3da6c610c8ffe17d6d2d3cc7068f17f
// via https://github.com/0xhckr/ghostty-shaders (bloom.glsl)
//
// Tunables:
//   THRESHOLD — how bright a pixel must be to glow (0..1). Lower = more glow.
...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
  ...
  vec2 step = vec2(RADIUS) / iResolution.xy;
